  ...
  return (
    <div className={`flex items-center justify-between ${classname}`}>
      <div className="px-3 py-4 space-y-6">
        ...
        <p className="text-gary-400 text-sm py-3 max-w-sm">
          Soul Foods aims to curate an unparalleled culinary journey, blending international flavors
          with local delicacies, and offering an immersive experience for every visitor.
        </p>
      ...
      <div className="w-1/2 h-full bg-cover bg-center px-3 py-4">
        <img src={imag} alt="" className="h-32 w-full sm:h-full " />
      </div>
    </div>
  );
};
